...
Route::get('terms-of-use', [TermsAcceptanceController::class, 'showPublic'])->name('terms.public');
Route::get('privacy-policy', [LegalPageController::class, 'privacy'])->name('legal.privacy');
Route::get('payment-refund-policy', [LegalPageController::class, 'paymentRefund'])->name('legal.payment-refund');
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('terms/accept', [TermsAcceptanceController::class, 'show'])->name('terms.accept');
    Route::post('terms/accept', [TermsAcceptanceController::class, 'accept'])->name('terms.accept.submit');
});
