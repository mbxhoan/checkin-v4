...
@section('buttons')
    <div class="buttons">
        <a href=""
            ...
            class="btn btn-primary btn-sm align-self-center mb-lg-0 mb-2"
        >
...
@section('primary-content')
    ...
    <div class="d-lg-flex justify-content-between align-items-middle">
        <form
            method="GET"
            action="{{ route('admin.clients.index', $event) }}"
            class="ms-1 d-flex align-items-center gap-2 w-75"
        >
            ...
            @foreach ($model->getStatues() as $key => $status)
                ...
                $params['event'] = $event;
            @endphp
                <a href="{{ route('admin.clients.index', $params) }}"
            ...
            @if (is_numeric($total) && $total > 0)
                ...
                @if ($notHavingImgQrcodes == 0)
                    ...
                    >
                        <x-icon name="qrcode" />
                        Tải Qrcodes
                        ({{ $total - $notHavingImgQrcodes }}/{{ $total }})
                    </a>
                @endif
            @endif
            {{-- @admin
