            ...
            <form method="GET" action="{{ $route }}">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-12">
                            @include('components.select', [
                                'label'         => __('reports.index.media.filter_field_label'),
                        ...
                        <div class="col-md-4 col-12">
                            @include('components.form-groups.input-group', [
                                ...
                                'label'             => __('reports.index.media.filter_from_date_label'),
                        ...
                        <div class="col-md-4 col-12">
                            @include('components.form-groups.input-group', [
                                ...
                                'label'             => __('reports.index.media.filter_to_date_label'),
                                'formClass'         => 'mb-3 col-12'
                            ])
                        </div>
                    </div>
                    <div class="row">
                        @sys_admin
                            @if (isset($companyArray))
                                <div class="col-md-4 col-12">
                                    @include('components.select', [
                                        'label'         => __('reports.index.media.filter_company_label'),
                        ...
                        @if (isset($proviceArray))
                            <div class="col-md-4 col-12">
                                @include('components.select', [
                                    'label'         => __('reports.index.media.filter_province_label'),
                        ...
                        <div class="col-md-4 col-12">
                            @include('components.select', [
                                'label'         => __('reports.index.media.filter_status_label'),
                                'fieldName'     => 'status',
                                'id'            => 'status',
                ...
                <div class="modal-footer">
                    <a href="{{ $route }}" class="btn btn-sm btn-danger">
                        {{ __('reports.index.media.filter_reset_button') }}
                    </a>

                    <button type="button" class="btn btn-sm btn-secondary" data-bs-dismiss="modal">
                        {{ __('reports.index.media.filter_close_button') }}
                    </button>
