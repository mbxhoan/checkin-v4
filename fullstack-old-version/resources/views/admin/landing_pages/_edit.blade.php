<a id="{{ $id ?? null }}"
    ...
    data-bs-target="#editLandingPageDetail-{{ $id }}"
>
    <x-icon name="edit" />
</a>

<div class="modal fade" id="editLandingPageDetail-{{ $id }}" data-bs-keyboard="true" tabindex="-1" aria-labelledby="editLandingPageDetail-{{ $id }}Label"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editLandingPageDetail-{{ $id }}Label">
                    Chỉnh sửa thông tin
                </h1>
