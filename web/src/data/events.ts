...
export const EVENTS: Event[] = [
  {
    ...
    color: "#2563eb",
    guestCount: 1247, registered: 892, checkedIn: 0, capacity: 1500,
    lastActivity: "2 phút trước",
    cover: "linear-gradient(135deg, #2563eb, #1e3a8a)", emoji: "🦷",
  },
  {
    ...
    color: "#16a34a",
    guestCount: 320, registered: 245, checkedIn: 0, capacity: 400,
    lastActivity: "1 giờ trước",
    cover: "linear-gradient(135deg, #16a34a, #064e3b)", emoji: "📊",
  },
  {
    ...
    color: "#dc2626",
    guestCount: 540, registered: 540, checkedIn: 387, capacity: 600,
    lastActivity: "Đang diễn ra • 5 phút trước",
    cover: "linear-gradient(135deg, #dc2626, #7f1d1d)", emoji: "🎤",
  },
  {
    ...
    color: "#6b7280",
    guestCount: 180, registered: 180, checkedIn: 165, capacity: 200,
    lastActivity: "2 tháng trước",
    cover: "linear-gradient(135deg, #6b7280, #374151)", emoji: "✨",
  },
  {
    ...
    status: "upcoming", statusLabel: "Sắp diễn ra",
    color: "#7c3aed",
    guestCount: 0, registered: 0, checkedIn: 0, capacity: 2000,
    lastActivity: "Hôm qua",
    cover: "linear-gradient(135deg, #7c3aed, #4c1d95)", emoji: "🏛",
  },
  {
    ...
    color: "#ca8a04",
    guestCount: 0, registered: 0, checkedIn: 0, capacity: 80,
    lastActivity: "3 ngày trước",
    cover: "linear-gradient(135deg, #ca8a04, #713f12)", emoji: "🦾",
  },
  {
    ...
    status: "draft", statusLabel: "Bản nháp",
    color: "#db2777",
    guestCount: 0, registered: 0, checkedIn: 0, capacity: 800,
    lastActivity: "1 tuần trước",
    cover: "linear-gradient(135deg, #db2777, #831843)", emoji: "🎉",
  },
  {
    ...
    status: "upcoming", statusLabel: "Sắp diễn ra",
    color: "#0891b2",
    guestCount: 95, registered: 62, checkedIn: 0, capacity: 150,
    lastActivity: "5 ngày trước",
    cover: "linear-gradient(135deg, #0891b2, #164e63)", emoji: "🥂",
  },
];
