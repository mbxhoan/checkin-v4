...
return [
    ...
    'title' => 'Delfi Check-in V4 — API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'Event Management SaaS API. Multi-tenant, RBAC-enabled, Sanctum-authenticated.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate via `POST /api/v1/auth/login` to get a Bearer token. Include it in the `Authorization` header as `Bearer {token}`. Scanner devices use `POST /api/v1/scanner/login` with device_code + PIN.',
    ],
